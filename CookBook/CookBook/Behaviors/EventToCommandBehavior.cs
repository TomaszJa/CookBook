...
namespace CookBook.Behaviors
{
    ...
    class EventToCommandBehavior : BindableBehavior<View>
    {
        ...
        // Określenie Komendy z ViewModel
        ...
        // event args converter konwertuje eventArgs z tapped event w View żeby otrzymać obiekt
        // z event args, do czego wykorzystuje konwerter
